...
mse_your_model = model.compute_loss(x, y)
r2_your_model = model.compute_r2(x, y)
...
# Compare values
print(f"MSE de tu modelo: {mse_your_model:.6f}")
print(f"R² de tu modelo: {r2_your_model:.6f}")
print(f"MSE de sklearn: {mse_sklearn:.6f}")
print(f"R² de sklearn: {r2_sklearn:.6f}")
